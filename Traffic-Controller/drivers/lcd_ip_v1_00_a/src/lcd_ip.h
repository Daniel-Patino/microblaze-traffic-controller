/*****************************************************************************
* Filename:          H:\xup\embedded\labs\lab2B/drivers/lcd_ip_v1_00_a/src/lcd_ip.h
* Version:           1.00.a
...
#define LCD_IP_mWriteSlaveReg0(BaseAddress, RegOffset, Value) \
 	xil_io_out32((BaseAddress) + (LCD_IP_SLV_REG0_OFFSET) + (RegOffset), (Xuint32)(Value))

#define LCD_IP_mReadSlaveReg0(BaseAddress, RegOffset) \
 	xil_io_in32((BaseAddress) + (LCD_IP_SLV_REG0_OFFSET) + (RegOffset))
