...
# Project:\\eic23\data_eic23\home\dpati007\Project\FinalProject\system.xmp
#
...
SIMGEN_OPTIONS = -p $(DEVICE) -lang $(LANGUAGE) $(SEARCHPATHOPT) $(BRAMINIT_ELF_FILE_ARGS) $(MIX_LANG_SIM_OPT) -msg __xps/ise/xmsgprops.lst -s mti -X H:/Project/FinalProject/
...
implementation/dip_wrapper.ngc \
implementation/lcd_ip_0_wrapper.ngc \
...
CYG_SDK_EXPORT_DIR = /cygdrive/h//Project/FinalProject/SDK/SDK_Export/hw
...
TESTAPP_MEMORY_MICROBLAZE_0_CC_INFERRED_FLAGS= -mno-xl-soft-mul -mxl-pattern-compare -mcpu=v7.30.a 
